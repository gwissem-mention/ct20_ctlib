...
class ActionCode
{
    ...
    /**
     * Get All Action Codes for Activities.
     *
     * @return array
     */
    public static function getActivityActionCodes()
    {
        return array(
            //self::CREATE_ACTIVITY,
            //self::CHANGE_ACTIVITY_STATUS,
            //self::CHANGE_ACTIVITY_ALERT_STATUS,
            //self::VIEW_CURRENT_ACTIVITIES,
            self::VIEW_ACTIVITY_DETAIL,
            //self::CLOSE_MULTIPLE_ACTIVITIES,
            self::UPDATE_ACTIVITY_DURATION,
            self::UPDATE_ACTIVITY_ADJUSTED_TRAVEL,
            self::UPDATE_ACTIVITY_FORM_RESPONSE,
            self::UPDATE_ACTIVITY_EXPORT,
            //self::VIEW_ACTIVITY_ALERTS,
            //self::ACKNOWLEDGE_ALERT,
            //self::VIEW_CLOSED_ACTIVITIES,
            //self::VIEW_SCHEDULES,
            self::DELETE_ACTIVITY,
            self::CLOSE_ACTIVITY,
            self::CLOSE_ACTIVITY_IN_BATCH,
            self::STOP_ACTIVITY_MANUAL
        );
    }

    /**
     * Get All Action Codes for Roles.
     *
     * @return array
     */
    public static function getRoleActionCodes()
    {
        return array(
            self::CREATE_ROLE,
            //self::UPDATE_ROLE,
            self::DELETE_ROLE,
            self::UPDATE_ROLE_NAME,
            self::UPDATE_ROLE_ENTITY_PERMISSIONS,
            self::UPDATE_ROLE_OBJECT_PERMISSIONS
        );
    }

    /**
     * Get All Action Codes for Schedules.
     *
     * @return array
     */
    public static function getScheduleActionCodes()
    {
        return array(
            self::CHANGE_SCHEDULE_STATUS,
            self::UPDATE_SCHEDULE_DETAIL,
            self::UPDATE_SCHEDULE_MEMBER,
            self::UPDATE_SCHEDULE_FILTER,
            self::SCHEDULE_ADD_ACTIVITY,
            self::SCHEDULE_DELETE_ACTIVITY,
            self::SCHEDULE_EDIT_ACTIVITY
        );
    }

    /**
     * Get All Action Codes for Members.
     *
     * @return array
     */
    public static function getMemberActionCodes()
    {
        return array(
            ...
            self::CREATE_MEMBER,
            self::UPDATE_MEMBER_GENERAL,
            self::UPDATE_MEMBER_CONTACT,
            self::UPDATE_MEMBER_FILTERS,
            self::UPDATE_MEMBER_ADDRESS,

            self::MEMBER_LOCATION_ADDRESS_UPDATE,
            self::MEMBER_LOCATION_ADDRESS_ADD,
            self::MEMBER_LOCATION_ADDRESS_VALIDATE,
            self::MEMBER_LOCATION_ADDRESS_INVALID_AUTOVALIDATE,
            //self::UPDATE_MEMBER_HCT_RELATION,
            self::UPDATE_MEMBER_HCT_AUTO_FILTER_GROUP,
            self::ADD_MEMBER_HCT_RELATION,
            self::REMOVE_MEMBER_HCT_RELATION,
            self::DELETE_MEMBER,
            self::UPDATE_MEMBER_ROLE,
            self::RESET_MEMBER_PASSWORD,
            self::RESET_MEMBER_DEVICE,
            self::LOCK_MEMBER_DEVICE,
            self::UNLOCK_MEMBER_DEVICE,
            self::VIEW_MEMBER_AUTH_UNLOCK_CODE,
            self::MEMBER_CREATE_CARE_PLAN,
            self::MEMBER_DELETE_CARE_PLAN,
            self::MEMBER_EDIT_CARE_PLAN,
            self::MEMBER_SAVE_CARE_PLAN,
            self::VIEW_ASSESSMENT_DETAIL,
            self::VIEW_CONSOLIDATED_ASSESSMENT,
            self::VIEW_CLINICAL_SUMMARY,
            self::PRINT_ASSESSMENT,
            self::PRINT_CONSOLIDATED_ASSESSMENT,
            self::VIEW_SCHEDULE_DETAIL,
            self::MEMBER_SAVE_ALERT_CONFIG,
            self::MEMBER_DELETE_ALERT_CONFIG,
            self::MEMBER_EDIT_ALERT_CONFIG,
            self::MEMBER_SAVE_ALERT_CONFIG,
            self::MEMBER_IVR_PIN_UPDATE
        );
    }

    /**
     * Get Universal Action Codes for Members.
     *
     * @return array
     */
    public static function getUniversalMemberActionCodes()
    {
        return
            [
                self::CHANGE_MEMBER_STATUS,
    ...
    /**
     * Get Address Action Codes for Members.
     *
     * @return array
     */
    public static function getAddressMemberActionCodes()
    {
        return
            [
                self::UPDATE_MEMBER_ADDRESS,
    ...
    /**
     * Get Filter Action Codes for Members.
     *
     * @return array
     */
    public static function getFilterMemberActionCodes()
    {
        return
            [
                self::UPDATE_MEMBER_FILTERS,
    ...
    /**
     * Get Password Action Codes for Members.
     *
     * @return array
     */
    public static function getPortalAccessMemberActionCodes()
    {
        return
            [
                self::UPDATE_MEMBER_ROLE,
    ...
    /**
     * Get Device Action Codes for Members.
     *
     * @return array
     */
    public static function geDeviceMemberActionCodes()
    {
        return
            [
                self::RESET_MEMBER_DEVICE,
    ...
    /**
     * Get All Action Codes for Self-Service.
     *
     * @return array
     */
    public static function getSelfServiceActionCodes()
    {
        return
            [
                self::CHANGE_PASSWORD,
                self::CHANGE_CHALLENGE_QUESTIONS,
    ...
    /**
     * Get All Action Codes for Login.
     *
     * @return array
     */
    public static function getLoginActionCodes()
    {
        return
            [
                self::LOGIN,
                self::LOGOUT,
                self::TIMEOUT,
                self::LOGOUT_MEMBER_DISABLED
            ];
    }


    /**
     * Get All Action Codes for View actions.
     *
     * @return array
     */
    public static function getViewActionCodes()
    {
        return
            [
                self::VIEW_ACTIVITY_DETAIL,
                ...
                self::VIEW_CONSOLIDATED_ASSESSMENT,
                self::VIEW_CLINICAL_SUMMARY,
                self::VIEW_PROGRESS_NOTES,
                self::VIEW_SCHEDULE,
                self::VIEW_SCHEDULE_DETAIL,
                //self::VIEW_MEMBERS,
                self::VIEW_PERFORMANCE_SCORECARD,
                self::VIEW_MEMBER_DETAIL,
                self::VIEW_MEMBER_AUTH_UNLOCK_CODE
            ];
    }
    ...
    /**
     * Get All Action Codes for MemberAlerts.
     *
     * @return array
     */
    public static function getMemberAlertActionCodes()
    {
        return array(
    ...
    /**
     * Get All Action Codes for HCTP.
     *
     * @return array
     */
    public static function getHCTPActionCodes()
    {
        return
        [
            self::PRINT_ASSESSMENT,
    ...
    public static function getImportMappingCodes()
    {
        return
        [
            self::IMPORT_MAPPING_VIEW,
            self::IMPORT_MAPPING_CREATE,
            self::IMPORT_MAPPING_DELETE,
            self::IMPORT_MAPPING_UPDATE,
            self::IMPORT_MAPPING_APPLY
        ];
    }
