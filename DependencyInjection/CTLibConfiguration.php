                            ...
                            ->prototype('array')
                                ->children()
                                    ...
                                    ->arrayNode('validatedTokenChecks')
                                        ...
                                        ->prototype('enum')
                                        ->values(['street', 'city', 'district', 'locality', 'subdivision', 'country'])
                                        ->end()
                                    ->end()
                                    ->arrayNode('componentSortOrder')
                                        ->info('Define how the order of geocoded address should be constructed.')
                                        ->prototype('enum')
                                        ->values(['street', 'street1', 'street2', 'street3', 'city', 'district', 'locality', 'subdivision', 'country', 'postalCode', 'lat', 'lng'])
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
                            ...
                            ->prototype('array')
                                ->children()
                                    ...
                                    ->arrayNode('validatedTokenChecks')
                                        ->info('Define each token to be validated')
                                        ->prototype('enum')
                                        ->values(['street', 'street1', 'street2', 'street3', 'city', 'district', 'locality', 'subdivision', 'country'])
                                        ->end()
                                    ->end()
                                    ->arrayNode('componentSortOrder')
                                        ->info('Define how the order of geocoded address should be constructed.')
                            ...
                            ->prototype('array')
                                ->children()
                                    ...
                                    ->arrayNode('componentSortOrder')
                                        ->info('Define how the order of geocoded address should be constructed.')
                                        ->prototype('enum')
                                        ->values(['street', 'city', 'district', 'locality', 'subdivision', 'country', 'lat', 'lng'])
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
